...
if (room == rMenu)
    draw_text(camera_get_view_x(view_camera[0]) + 43, camera_get_view_y(view_camera[0]) + 15, "Select a slot to load.");
else
    draw_text(camera_get_view_x(view_camera[0]) + 43, camera_get_view_y(view_camera[0]) + 15, "Select a slot to save.");
