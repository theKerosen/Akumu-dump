...
:[1]
push.s "Select a slot to load."@1518
conv.s.v
pushi.e -6
pushi.e 0
push.v [array]self.view_camera
...
:[2]
push.s "Select a slot to save."@1519
conv.s.v
pushi.e -6
pushi.e 0
push.v [array]self.view_camera
...
> gml_Script_cleanRoomName@gml_Object_oSaveSlots_Draw_0 (locals=3, argc=1)
:[12]
pushi.e 1
conv.i.v
pushi.e 1
...
:[20]
push.i [function]gml_Script_cleanRoomName@gml_Object_oSaveSlots_Draw_0
conv.i.v
pushi.e -1
conv.i.v
...
call.i gml_Script_cleanRoomName@gml_Object_oSaveSlots_Draw_0(argc=1)
...
> gml_Script_to2digits@gml_Object_oSaveSlots_Draw_0 (locals=0, argc=1)
:[22]
push.v arg.argument0
pushi.e 10
cmp.i.v LT
...
:[27]
push.i [function]gml_Script_to2digits@gml_Object_oSaveSlots_Draw_0
conv.i.v
pushi.e -1
conv.i.v
call.i method(argc=2)
...
popz.v
pushloc.v local.h
call.i gml_Script_to2digits@gml_Object_oSaveSlots_Draw_0(argc=1)
push.s ":"@1535
add.s.v
pushloc.v local.m
call.i gml_Script_to2digits@gml_Object_oSaveSlots_Draw_0(argc=1)
